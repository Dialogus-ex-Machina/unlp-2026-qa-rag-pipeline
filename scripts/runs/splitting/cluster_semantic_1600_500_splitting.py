...
from merlin.rag.index.splitters import SentenceSplitter, ClusterSemanticSplitter
...
"""Index pipeline configuration:
    1) Load: TxtLoadNode
    2) Split: ClusterSemanticSplitter(max_chunk_size=1600, min_chunk_size=500)
...
def main():
    ...
    nodes = [
        ...
        PageAwareDocumentSplitNode(
            splitter=ClusterSemanticSplitter(
