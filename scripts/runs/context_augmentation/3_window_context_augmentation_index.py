...
from merlin.rag.index.nodes import DelimitedPageLoadNode, ProxySplitNode, ContextualSplitsAugmentationNode
...
"""Index pipeline configuration:
    ...
    3) ContextualSplitsAugmentationNode(sliding_window=3)
